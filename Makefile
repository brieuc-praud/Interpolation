...
OBJ 		  := parameters.o predicatesf90.o mesh.o polygon_tools.o interpolation.o $(EXE).o
OBJ_TESTS     := parameters.o predicatesf90.o mesh.o polygon_tools.o interpolation.o $(EXE_TESTS).o
...
clean:
	rm *.o *.mod *.mesh $(EXE) $(EXE_TESTS) $(ERROR_FILE) 2>/dev/null | true
